...
if __name__ == '__main__':
    ...
    parser.add_argument("--dataset_subset_size", type=int, default=15000)
    ...
    parser.add_argument("--delete_models", action='store_false')
    ...
    out_dir = os.path.join(get_root_dir(), 'output', 'experiments', 'us_air', args.experiment_name)
